...
function mostrar(valor)
{
	if(valor === "logs")
	{
		AjaxConsulta( '../logica/proc_mostrar_tablas.php', {BASE_DE_DATOS:'bilden_mym', DIV:'tablas_bd', NOMBRE_SELECT:'stabla', ESTADO:'', ACCION:'consultar_tablas_logs'}, 'tablas_bd');
		AjaxConsulta( '../logica/admin_la.php', '', 'atributos');
	}
	else if(valor === "auditorias")
	{
		AjaxConsulta( '../logica/proc_mostrar_tablas.php', {BASE_DE_DATOS:'au_bilden_mym', DIV:'tablas_bd', NOMBRE_SELECT:'stabla', ESTADO:'', ACCION:'consultar_tablas'}, 'tablas_bd');
		AjaxConsulta( '../logica/admin_la.php', '', 'atributos');
	}
	else
	{
