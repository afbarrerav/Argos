...
function generar_reporte()
{
	...
	var tiposeguimiento	= document.getElementById('sTipoSeguimiento').value;
	...
	if (campana>0)
	{
		if(desde.length > 0)
		{
			...
			if(((desde.length >0)&&(hasta >= desde)))
			{
				...
				{
					AjaxConsulta('../logica/seguimiento_campana.php', {campana:campana, tiposeguimiento:tiposeguimiento, desde:desde, hasta:hasta, ACCION:'generar_reporte_consolidado'}, 'area_trabajo' );
				}	
				if(tiposeguimiento==2)
				{
					AjaxConsulta('../logica/seguimiento_campana.php', {campana:campana, tiposeguimiento:tiposeguimiento, desde:desde, hasta:hasta, ACCION:'generar_reporte_detallado'}, 'area_trabajo' );
				}
			}
			else
			{
	...
	{
		alert('Debe seleccionar la campana');
	}	
}
...
function det_cant_llamadas()
{
	...
	if(desde.length > 0)
	{
		...
		if(((desde.length >0)&&(hasta >= desde)))
		{
			AjaxConsulta('../logica/seguimiento_campana.php', {campana:campana, tiposeguimiento:tiposeguimiento, desde:desde, hasta:hasta, ACCION:'det_cant_llamadas'}, 'detalle_reporte' );
		}
		else
		{
			alert('La fecha de fin debe ser mayor a la fecha de inicio');
