...
<table border="0" width="100%" align="center" style="background: #FFF; border: 1px solid #CCC;">
	...
	<tr>
		...
		<td class="texto_tabla" width="50%">
			<?php 
			if(($atributos[$l]!="tcg_codigo")&&($atributos[$l]!="ciu_codigo")&&($atributos[$l]!="dep_codigo")&&($atributos[$l]!="pai_codigo")&&($atributos[$l]!="tp_codigo")&&($atributos[$l]!="to_codigo")&&($atributos[$l]!="ts_codigo")&&($atributos[$l]!="estr_codigo")&&($atributos[$l]!="ser_codigo")&&($atributos[$l]!="pro_codigo")&&($atributos[$l]!="tep_codigo")&&($atributos[$l]!="prod_codigo"))
			{?>
