	...
	<tr>
		<td  colspan ="<?php echo $i+1;?>">
			<img src="imagenes/iconos/add_a.png" alt="Agregar" title="Agregar"
				...
				onclick="AjaxConsulta( '../logica/admin_ic.php', {TABLA:'<?php echo $tabla?>', ACCION:'form_nuevo_ic'}, 'administarICDiv' );"/>
		</td>
	</tr>
	<tr>
		<td  colspan ="<?php echo $i+1;?>">
				...
				<tr class="fila">
					...
					<td class="texto_tabla">
						<img src="imagenes/iconos/edit_a.png" alt="Editar" title="Editar"
							...
							width="20"
							align="absbottom"
							onclick="AjaxConsulta( '../logica/admin_ic.php', {TABLA:'<?php echo $tabla?>', CODIGO:'<?php echo $registros['codigo'][$m]?>', ACCION:'form_editar_ic'}, 'administarICDiv' );"/>
						<?php 
						...
						<img src="imagenes/iconos/round_remove_a.png" alt="Desactivar" title="Desactivar"
							...
							width="20"
							align="absbottom"
							onclick="AjaxConsulta( '../logica/admin_ic.php', {TABLA:'<?php echo $tabla?>', CODIGO:'<?php echo $registros['codigo'][$m]?>', EST_CODIGO:'2', ACCION:'actualizar_estado'}, 'administarICDiv' );"/>
						<?php 
						}
						...
						<img src="imagenes/iconos/round_ok_a.png" alt="Activar" title="Activar"
							...
							width="20"
							align="absbottom"
							onclick="AjaxConsulta( '../logica/admin_ic.php', {TABLA:'<?php echo $tabla?>', CODIGO:'<?php echo $registros['codigo'][$m]?>', EST_CODIGO:'1', ACCION:'actualizar_estado'}, 'administarICDiv' );"/>
						<?php 
						}
						?>
					</td>
