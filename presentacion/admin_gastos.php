...
<table border="0" width="100%" align="center" style="background: #FFF; border: 1px solid #CCC;">
			...
			<table border="0" width="100%" align="center" style="background: #FFF; border: 0px solid #CCC;">
				...
				<tr>
					<td colspan="4" style="background: #FFF; border: 1px solid #CCC;">
						<img src="imagenes/iconos/add_a.png" alt="Crear Gasto" title="Crear Gasto"
				...
				<tr height="30">
					<td class="titulo_tabla">Administraci&oacute;n Gastos</td>
				</tr>
			</table>
		</td>
	</tr>
	<tr>
		...
		<td colspan="10" align="center"><input type="button" name="bt1" value='Buscar' class="boton" title="Haga clic para buscar" onclick="buscar();"></td>
	</tr>
</table>
<br>
<div id="adm_gastos_listar"></div>