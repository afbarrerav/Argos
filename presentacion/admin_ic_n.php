...
<?php
	...
	if (formulario_valido == 0) 
	{
		...
		AjaxConsulta( '../logica/admin_ic.php', {TABLA:'<?php echo $tabla?>', <?php echo $parametros?> ACCION:'guardar_nuevo_ic'}, 'administarICDiv' ); 
	}
}
</script>
	...
	for($l=0;$l<$i;$l++)
	{
		...
		<tr>
			...
			<td class="texto_tabla" width="50%">
				<?php 
				if(($atributos['Field'][$l]!="tcg_codigo")&&($atributos['Field'][$l]!="est_codigo")&&($atributos['Field'][$l]!="ciu_codigo")&&($atributos['Field'][$l]!="dep_codigo")&&($atributos['Field'][$l]!="pai_codigo")&&($atributos['Field'][$l]!="tp_codigo")&&($atributos['Field'][$l]!="to_codigo")&&($atributos['Field'][$l]!="ts_codigo")&&($atributos['Field'][$l]!="estr_codigo")&&($atributos['Field'][$l]!="ser_codigo")&&($atributos['Field'][$l]!="pro_codigo")&&($atributos['Field'][$l]!="tep_codigo")&&($atributos['Field'][$l]!="prod_codigo"))
				{?>
