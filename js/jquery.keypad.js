...
function Keypad() {
	...
	this.qwertyLayout = [ this.HALF_SPACE + this.SPACE + this.CLOSE,
		this.HALF_SPACE + '1234567890',
		'qwertyuiop' + this.HALF_SPACE + '',
		this.HALF_SPACE + 'asdfghjkl' + this.SPACE ,
		this.SPACE + 'zxcvbnm' + this.SPACE + this.HALF_SPACE ,
	...
	this.regional[''] = { // Default regional settings
		...
		closeStatus: 'Cerrar el teclado', // Status text for close link
		clearText: 'Limpiar', // Display text for clear link
		clearStatus: 'Borrar todo el texto', // Status text for clear link
		backText: 'Borrar', // Display text for back link
		backStatus: 'Borrar el ultimo digito', // Status text for back link
		spacebarText: '&nbsp;', // Display text for space bar
		spacebarStatus: 'Space', // Status text for space bar
		//enterText: 'Entrar', // Display text for carriage return
		...
		shiftText: 'Mayus', // Display text for shift link
		shiftStatus: 'Muyuscula / Minuscula', // Status text for shift link
