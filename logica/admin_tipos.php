...
try
{
	...
	{
		include ('../presentacion/admin_ic.php');
	}
	
	if($accion == "form_editar_tipos")
	{
		...
		include ('../presentacion/admin_tipos_e.php');
	}
	
	if($accion == "form_nuevo_tipos")
	{
		$tabla 	= $_REQUEST['TABLA'];
		...
		include ('../presentacion/admin_tipos_n.php');
	}
	
	if($accion == "editar_tipos")
	{
		$tabla 	= $_REQUEST['TABLA'];
	...
	if($accion == "sadministarIC")
	{
		 ...
		 * */		
		include ('../presentacion/admin_tipos_detalle.php');
	}
}
