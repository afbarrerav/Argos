...
Function ingresoClientesOffline($ti_codigo,$nroidentificacion,$referencia,$razon_social,$tn_codigo,$nombre1_contacto,
$nombre2_contacto,$apellido1_contacto,$apellido2_contacto,$telefono1,$ext1,$telefono2,$ext2,$celular1,$celular2,$email,
$barrio,$direccion,$comentario,$calificacion,$ciu_codigo,$est_codigo, $usuario, $pwd)
{
		$consulta= new Consultas();
		$ingresoTransaccion1 = $consulta->ingreso_Clientes_Offline($ti_codigo,$nroidentificacion,$referencia,$razon_social,
		$tn_codigo,$nombre1_contacto,$nombre2_contacto,$apellido1_contacto,$apellido2_contacto,$telefono1,$ext1,$telefono2,
		$ext2,$celular1,$celular2,$email,$barrio,$direccion,$comentario,$calificacion,$ciu_codigo,$est_codigo,$usuario,$pwd);
...
Function IngresoSolicitudOffline($codigo_barras,$referencia,$fecha_solicitud,$cli_codigo,$aju_codigo,$ttp_codigo,$tp_codigo,$tnc_codigo,$valor_producto,$valor_comision_servicio,
	$valor_impuesto,$valor_total,$fecha_entrega,$est_codigo, $usuario, $pwd)
{
		$consulta= new Consultas();
		$ingresoTransaccion1 = $consulta->ingreso_Solicitud_Offline($codigo_barras,$referencia,$fecha_solicitud,$cli_codigo,$aju_codigo,$ttp_codigo,$tp_codigo,$tnc_codigo,$valor_producto,$valor_comision_servicio,
	$valor_impuesto,$valor_total,$fecha_entrega,$est_codigo, $usuario, $pwd);
...
Function ingresoTransaccionOffline($tv_codigo,$aju_codigo,$cuotas_totales,$cuota_nro,$fecha_pago,
	$valor_pago,$fecha_recaudo,$valor_recaudo,$fecha_trans,$longitud,$latitud,$est_codigo, $usuario, $pwd)
{
	$consulta= new Consultas();
		$ingresoTransaccion1 = $consulta->ingreso_Transaccion_Offline($tv_codigo,$aju_codigo,$cuotas_totales,$cuota_nro,$fecha_pago,
		$valor_pago,$fecha_recaudo,$valor_recaudo,$fecha_trans,$longitud,$latitud,$est_codigo, $usuario, $pwd);
		if($ingresoTransaccion1!="")
		{
			return $ingresoTransaccion1;
