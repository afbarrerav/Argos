...
try
{
	...
	if($accion == "form_editar_ic")
	{
		...
		include ('../presentacion/admin_ic_e.php');
	}
	
	if($accion == "form_nuevo_ic")
	{
		$tabla 	= $_REQUEST['TABLA'];
		...
		include ('../presentacion/admin_ic_n.php');
	}
	...
	if($accion == "sadministarIC")
	{
		 ...
		 * */		
		include ('../presentacion/admin_ic_detalle.php');
	}
}
